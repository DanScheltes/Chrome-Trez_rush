...
class MultiDinoGame:
    def __init__(self, dino_count, fps=60):
        ...
        self.font = pygame.font.Font(
            None, 24
        )  # Inicializa a fonte padrÃ£o com tamanho 24
        self.reset()
    ...
    def step(self, actions):
        ...
        # print(obstaculos)
        MIN_DISTANCE = 200 * self.gamespeed  # DistÃ¢ncia mÃ­nima entre os obstÃ¡culos
        if obstaculos < 3:
            if obstaculos == 0:
        ...
        self.screen.blit(gamespeed_text, (10, 10))  # PosiÃ§Ã£o (10, 10) na tela
